...
var handle = function handle(props) {
  ...
  return _react.default.createElement(_rcTooltip.default, {
    ...
    placement: "top",
    key: index
  }, _react.default.createElement(Handle, _extends({
    value: value
  }, restProps)));
};
...
/*#__PURE__*/
function (_Component) {
  _inherits(GraphScroll, _Component);

  function GraphScroll(props) {
    var _this;

    _classCallCheck(this, GraphScroll);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(GraphScroll).call(this, props));
    _this.state = {};
    return _this;
  }

  _createClass(GraphScroll, [{
    key: "render",
    value: function render() {
      return _react.default.createElement("span", null, _react.default.createElement("span", {
        ...
        trackStyle: [{
          background: this.props.color ? this.props.color : "#008081"
        }],
