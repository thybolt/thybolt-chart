...
function (_Component) {
  ...
  function ThyboltChart(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "componentDidMount", function () {
      ...
      if (_this.props.initalGraphWindow) _this.DEFAULT_NVALUES = parseFloat(_this.props.initalGraphWindow ? _this.props.initalGraphWindow : 0.0);else _this.DEFAULT_NVALUES = 0.1;

      _this.graphUpdated();

      if (_this.props.data) _this.refreshInterval = setInterval(function () {
      ...
      if (_this.props.descriptor) {
        try {
          ...
          for (var _i = 0; _i < _this.props.descriptor.y.length; _i++) {
            ...
            var scale = parseFloat(_this.props.descriptor.y[_i].scale ? _this.props.descriptor.y[_i].scale : 0.0);
            scale = scale ? scale : 1.0;
            var offset = parseFloat(_this.props.descriptor.y[_i].offset ? _this.props.descriptor.y[_i].offset : 0.0);
            offset = offset ? offset : 0.0;

            for (var j = 0; j < _tempx.length; j++) {
              // Y = a * X + B
              var _value = parseFloat(_tempy[_i][j] * scale + offset);

              var value = _value ? _value : null;

              var _valueUnscaled = parseFloat(_tempy[_i][j]);

              var valueUnscaled = _valueUnscaled ? _valueUnscaled : null; // this._xydata[i].unshift({
              // 	index:j,
              ...
              _this._xydata[_i].unshift({
                ...
                x0: j + (parseFloat(_this.props.descriptor.y[_i].width ? _this.props.descriptor.y[_i].width : 0.0) ? parseFloat(_this.props.descriptor.y[_i].width ? _this.props.descriptor.y[_i].width : 0.0) : 0.0) * 0.01,
                x: j,
                y: value
              });
  ...
  _createClass(ThyboltChart, [{
    ...
    value: function render() {
      ...
      try {
        ...
        }, this.props.noScrollBar || this.state.graphMode && _react.default.createElement("span", null, _react.default.createElement("span", {
          style: {
        ...
        }))), !this.props.noTable && _react.default.createElement("span", {
        ...
        })), !this.props.noButtonControl && _react.default.createElement("span", null, _react.default.createElement("span", {
        ...
        }, this.labels)))), !this.props.noLegends && _react.default.createElement(_reactVis.DiscreteColorLegend, {
          height: 60,
