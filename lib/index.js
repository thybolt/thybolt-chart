...
function (_Component) {
  ...
  function ThyboltChart(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "componentDidMount", function () {
      ...
      if (_this.props.initalGraphWindow) _this.DEFAULT_NVALUES = parseFloat(_this.props.initalGraphWindow);else _this.DEFAULT_NVALUES = 0.1;
          ...
          for (var _i = 0; _i < _this.props.descriptor.y.length; _i++) {
            ...
            for (var j = 0; j < _tempx.length; j++) {
              ...
              _this._xydata[_i].unshift({
                xv: _tempx[j],
                x0: j + parseFloat(_this.props.descriptor.y[_i].width ? _this.props.descriptor.y[_i].width : 0.0) * 0.01,
                x: j,
                y: value
              });
